...
function car2_up() {
    if (car2_y >= 0) {
        car2_y -= 10;
        console.log("When Up Arrow Is Pressed For Car 2, x= " + car2_x + ", y= " + car2_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
    }
...
function car2_down() {
    if (car2_y <= 500) {
        car2_y += 10;
        console.log("When Down Arrow Is Pressed For Car 2, x= " + car2_x + ", y= " + car2_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
    }
...
function car2_left() {
    if (car2_x >= 0) {
        car2_x -= 10;
        console.log("When Left Arrow Is Pressed For Car 2, x= " + car2_x + ", y= " + car2_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
    }
...
function car2_right() {
    if (car2_x <= 500) {
        car2_x += 10;
        console.log("When Right Arrow Is Pressed For Car 2, x= " + car2_x + ", y= " + car2_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
    }
